export default {
  ...
  components: {
    ...
    such_as_dataeasedataease: '请输入登录页面标题，比如：Compass',
    for_example_dataease: '请输入系统名称，比如：Compass',
  ...
  wizard: {
    ...
    contact_us: '联系我们',
    demo_video_hint: '如何3分钟制作一个Compass数据看板、并分享给他人',
    online_document_hint: '涵盖Compass的安装步骤、用户手册、使用教程、常见问题的解决方案、以及二次开发等',
